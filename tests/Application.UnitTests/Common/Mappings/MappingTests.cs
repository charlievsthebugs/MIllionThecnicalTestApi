...
using MillionTest.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using MillionTest.Application.TodoLists.Queries.GetTodos;
using MillionTest.Domain.Entities;
using Microsoft.Extensions.Logging;
using NUnit.Framework;

namespace MillionTest.Application.UnitTests.Common.Mappings;
